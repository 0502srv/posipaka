...
MAX_CONCURRENT_SESSIONS = 3  # Audit 102.15: concurrent session limit per IP
...
class AuthManager:
    ...
    def create_session(self, client_ip: str) -> str:
        # Audit 102.15: enforce concurrent session limit per IP
    ...
    def cleanup_old_timestamps(self) -> None:
        """Видалити застарілі записи про невдалі спроби (bugfix 102.18)."""
        now = time.time()
