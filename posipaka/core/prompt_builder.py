...
RESPONSE_RULES = (
    ...
    "11. Використовуй інструменти ТІЛЬКИ коли користувач явно просить: "
    "web_search — якщо просить знайти, set_reminder — якщо просить нагадати, "
    "get_weather — якщо питає про погоду. НЕ додавай зайві виклики за власною ініціативою "
    "(наприклад, не додавай погоду якщо не питали). "
    "НІКОЛИ не використовуй write_file/shell_exec для відповідей — пиши ТЕКСТОМ.\n"
    "12. Якщо користувач надіслав URL — використай web_fetch щоб отримати вміст, "
    "потім коротко підсумуй ТЕКСТОМ. Не зберігай у файл.\n"
